...
var FloattingButton = (0, _reactEmotion2.default)("div")({
  position: "fixed",
  bottom: "16px",
  right: "16px",
  background: _theme2.default.mainBg,
  boxShadow: "0 0 30px " + _theme2.default.black30,
  borderRadius: "50%",
  padding: "4px 6px",
...
function DevToolsCollapsed(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("title", null, "prosemirror"),
      _react2.default.createElement("desc", null, "Created using Figma"),
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement("path", {
          id: "e",
          d:
            "M.687 36.474c3 13.3 17.9 29.9 30.4 41.6 24.8 23.2 42 22.4 86 54.7-18.2-51.8-18.8-62-43.5-106.1-24.7-44-67.6-20.3-67.6-20.3s-8.4 16.6-5.3 29.9v.2z"
        }),
        _react2.default.createElement("path", {
          id: "f",
          d:
            "M38.346 11.5s-4-11.6-18-11.5c-30 .2-28.8 52.1 16.9 52 39.6-.1 39.2-49.4 16.1-49.6-10.2-.2-15 9.1-15 9.1z"
        }),
        _react2.default.createElement("path", {
          id: "g",
          d:
            "M26.5 15c10.8 0 2 14.9-.6 20.9-1.8-8.4-10.2-20.9.6-20.9zM10.2.1C4.6.1 0 4.6 0 10.3c0 5.6 4.5 10.2 10.2 10.2 5.6 0 10.2-4.5 10.2-10.2C20.4 4.7 15.9.1 10.2.1zM40.7 0c-4.8 0-8.8 4.5-8.8 10.2 0 5.6 3.9 10.2 8.8 10.2 4.8 0 8.8-4.5 8.8-10.2C49.5 4.6 45.6 0 40.7 0z"
        })
      )
    )
  );
